...
const WheelOfFortune = () => {
  ...
  const loadFromStorage = () => {
    try {
      ...
      return {
        originalNames: savedData.originalNames ||  ['Юра', 'Сергей', 'Костя', 'Полина', 'Рома', 'Кристина', 'Кирилл', 'Андрей', 'Оля', 'Маша', 'Саша', 'Ани', 'Илья Гаврилов', 'Илья Голов', 'Леша'],
        currentNames: savedData.currentNames ||  ['Юра', 'Сергей', 'Костя', 'Полина', 'Рома', 'Кристина', 'Кирилл', 'Андрей', 'Оля', 'Маша', 'Саша', 'Ани', 'Илья Гаврилов', 'Илья Голов', 'Леша'],
        selectedHistory: savedData.selectedHistory || []
      };
    } catch {
      return {
        originalNames: ['Юра', 'Сергей', 'Костя', 'Полина', 'Рома', 'Кристина', 'Кирилл', 'Андрей', 'Оля', 'Маша', 'Саша', 'Ани', 'Илья Гаврилов', 'Илья Голов', 'Леша'],
        currentNames: ['Юра', 'Сергей', 'Костя', 'Полина', 'Рома', 'Кристина', 'Кирилл', 'Андрей', 'Оля', 'Маша', 'Саша', 'Ани', 'Илья Гаврилов', 'Илья Голов', 'Леша'],
        selectedHistory: []
      };
    }
  };
