...
const WheelOfFortune = () => {
  ...
  const loadFromStorage = () => {
    try {
      ...
      return {
        originalNames: savedData.originalNames ||  ['Юра', 'Сергей', 'Костя', 'Полина', 'Рома', 'Кристина', 'Кирилл', 'Андрей', 'Оля', 'Маша', 'Саша'],
        currentNames: savedData.currentNames ||  ['Юра', 'Сергей', 'Костя', 'Полина', 'Рома', 'Кристина', 'Кирилл', 'Андрей', 'Оля', 'Маша', 'Саша'],
        selectedHistory: savedData.selectedHistory || []
      };
    } catch {
      return {
        originalNames: ['Юра', 'Сергей', 'Костя', 'Полина', 'Рома', 'Кристина', 'Кирилл', 'Андрей', 'Оля', 'Маша', 'Саша'],
        currentNames: ['Юра', 'Сергей', 'Костя', 'Полина', 'Рома', 'Кристина', 'Кирилл', 'Андрей', 'Оля', 'Маша', 'Саша'],
        selectedHistory: []
      };
    }
  };
